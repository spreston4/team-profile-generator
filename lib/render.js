...
let newMan = new Manager('Sam', 1, 'sam@email.com', 1234);
let newEng =  new Engineer('Tim', 2, 'tim@email.com', 'tim1234');
let newInt = new Intern('Dan', 3, 'dan@email.com', 'UW');

let employeeArr = [newMan, newEng, newInt];
